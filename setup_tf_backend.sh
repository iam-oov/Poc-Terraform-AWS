...
# Define full paths using variables sourced from .env
TF_BACKEND_KEY="states/${PROJECT_NAME_PREFIX}/terraform.tfstate"
...
echo "--- Creando el archivo 'variables.tf' en '${PRE_TERRAFORM_DIR}' ---"
cat > "${PRE_TERRAFORM_DIR}/${GENERATED_VARIABLES_TF_FILENAME}" <<EOL
